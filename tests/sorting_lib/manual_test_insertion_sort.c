...
int main()
{
    ...
    runInsertionSortTest(array1, size1, "Test case 1: Regular array");

    // Test case 2: Empty array
    int emptyArray[] = {};
    size_t sizeEmpty = sizeof(emptyArray) / sizeof(emptyArray[0]);

    runInsertionSortTest(emptyArray, sizeEmpty, "Test case 2: Empty array");

    // Test case 3: Array with a single element
    int singleElementArray[] = {42};
    size_t sizeSingle = sizeof(singleElementArray) / sizeof(singleElementArray[0]);

    runInsertionSortTest(singleElementArray, sizeSingle, "Test case 3: Array with a single element");
    ...
    runInsertionSortTest(sortedArray, sizeSorted, "Test case 4: Already sorted array");
    ...
    runInsertionSortTest(duplicateArray, sizeDuplicate, "Test case 5: Array with duplicate elements");
