...
int main()
{
    ...
    insertionSort(emptyArray, sizeEmpty);
    ...
    insertionSort(singleElementArray, sizeSingle);
    ...
    insertionSort(sortedArray, sizeSorted);
    ...
    insertionSort(duplicateArray, sizeDuplicate);
